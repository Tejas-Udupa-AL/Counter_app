...
class _$_CounterModel with DiagnosticableTreeMixin implements _CounterModel {
  _$_CounterModel(this.counterValue);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CounterModel(counterValue: $counterValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'CounterModel'))
      ..add(DiagnosticsProperty('counterValue', counterValue));
  }
...
abstract class _CounterModel implements CounterModel {
  factory _CounterModel(final int counterValue) = _$_CounterModel;
...
class _$_QuotesModel with DiagnosticableTreeMixin implements _QuotesModel {
  _$_QuotesModel(this.quote);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'QuotesModel(quote: $quote)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'QuotesModel'))
...
abstract class _QuotesModel implements QuotesModel {
  factory _QuotesModel(final String quote) = _$_QuotesModel;
